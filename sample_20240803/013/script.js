...
// = 013 ======================================================================
// テクスチャの補間方法の指定とはまた別に、テクスチャパラメータには「範囲外のテ
// クスチャ座標をどのように扱うか」という設定項目があります。
// 通常、テクスチャ座標は常に 0.0 ～ 1.0 の範囲で設定されるべきなのですが、その
// 範囲から外れた値をどのように処理するか、という意味です。
// WRAP_S が横方向、WRAP_T が縦方向に対する設定値で、選択肢は３つあります。それ
// ぞれに、どのような挙動の違いが出るのか確かめてみましょう。
// ============================================================================
